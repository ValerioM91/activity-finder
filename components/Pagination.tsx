...
function PaginationNumber({
  ...
  const className = clsx("flex h-10 w-10 items-center justify-center text-sm border", {
    ...
    "text-bg-base-300": position === "middle",
  })
...
function PaginationArrow({
  ...
  const className = clsx("flex h-10 w-10 items-center justify-center rounded border", {
    "pointer-events-none text-bg-base-300": isDisabled,
